...
export const ClassroomList = () => {
    ...
    const {name,capacity,onResetForm,forceChange,formState,onInputChange,bulkForceChange} = useForm({name:'',capacity: 0, id: -1})
    ...
    return <>
        ...
        <SimpleTableList edit={true} reload={updateForm} remove={true} url={'classrooms'} headers={
            ['#', 'Nombre', 'Capacidad']
        } keys={['id', 'name', 'capacity']}
            onDelete={onDelete}
            onEdit={onEdit}
        />
    </>
